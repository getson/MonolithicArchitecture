...
namespace MyApp.Core.Domain.Services.Logging
{
    ...
    public static class LoggingExtensions
    {
        ...
        public static void Debug(this ILogger logger, string message, Exception exception = null, User.User user = null)
        {
        ...
        /// <param name="exception">Exception</param>
        /// <param name="user">user</param>
        public static void Information(this ILogger logger, string message, Exception exception = null, User.User user = null)
        {
        ...
        /// <param name="exception">Exception</param>
        /// <param name="user">user</param>
        public static void Fatal(this ILogger logger, string message, Exception exception = null,User.User user=null)
        {
