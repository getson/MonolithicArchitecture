...
namespace MyApp.Core.Infrastructure
{
    ...
    public class MyAppEngine : IEngine
    {
        ...
        public void Initialize(IServiceCollection services)
        {
            ...
            CommonHelper.DefaultFileProvider = new MyAppFileProvider(hostingEnvironment);

            //initialize plugins
            var myAppConfig = provider.GetRequiredService<MyAppConfig>();
            var mvcCoreBuilder = services.AddMvcCore();
            PluginManager.Initialize(mvcCoreBuilder.PartManager, myAppConfig);
        }
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services, IConfigurationRoot configuration)
        {
            ...
            var fileProvider = Resolve<IMyAppFileProvider>();
            AppDomain.CurrentDomain.SetData("DataDirectory", fileProvider.MapPath("~/App_Data/"));

            return _serviceProvider;
        }

        private void ConfigureStartupsServices(IServiceCollection services, IConfigurationRoot configuration, WebAppTypeFinder typeFinder)
        {
