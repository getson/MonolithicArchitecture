...
namespace MyApp.Core.Infrastructure.Implementation
{
    ...
    /// </summary>
    public class MyAppFileProvider : PhysicalFileProvider, IMyAppFileProvider
    {
        /// <summary>
        /// Initializes a new instance of a MyAppFileProvider
        /// </summary>
        /// <param name="hostingEnvironment">Hosting environment</param>
        public MyAppFileProvider(IHostingEnvironment hostingEnvironment) 
