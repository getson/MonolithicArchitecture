...
namespace MyApp.Infrastructure.Common.Helpers
{
    ...
    public class UserAgentHelper : IUserAgentHelper
    {
        ...
        /// Ctor
        /// </summary>
        /// <param name="MyAppConfig">Config</param>
        /// <param name="httpContextAccessor">HTTP context accessor</param>
        /// <param name="fileProvider">File provider</param>
        public UserAgentHelper(MyAppConfig MyAppConfig, IHttpContextAccessor httpContextAccessor, IMyAppFileProvider fileProvider)
        {
