...
namespace MyApp.Infrastructure.Common.Authentication
{
    /// <summary>
    /// Default values related to cookie-based authentication handler
    /// </summary>
    public static class MyAppCookieAuthenticationDefaults
    {
        /// <summary>
        ...
        /// </summary>
        public static readonly string CookiePrefix = ".MyApp.";
