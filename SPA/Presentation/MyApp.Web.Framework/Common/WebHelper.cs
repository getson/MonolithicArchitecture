...
namespace MyApp.Web.Framework.Common
{
    ...
    public partial class WebHelper : IWebHelper
    {
        ...
        public virtual bool IsPostBeingDone
        {
            get
            {
                if (_httpContextAccessor.HttpContext.Items["MyApp.IsPOSTBeingDone"] == null)
                    return false;

                return Convert.ToBoolean(_httpContextAccessor.HttpContext.Items["MyApp.IsPOSTBeingDone"]);
            }

            set => _httpContextAccessor.HttpContext.Items["MyApp.IsPOSTBeingDone"] = value;
        }
