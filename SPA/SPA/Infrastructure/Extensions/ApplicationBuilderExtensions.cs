...
using MyApp.Infrastructure.Common.Http;
using MyApp.Infrastructure.Data;
using SPA.Infrastructure.Globalization;
using SPA.Infrastructure.Middleware;
using SPA.Routing;

namespace SPA.Infrastructure.Extensions
{
    /// <summary>
    ...
    public static class ApplicationBuilderExtensions
    {
        ...
        /// </summary>
        /// <param name="application">Builder for configuring an application's request pipeline</param>
        public static void UseMyAppExceptionHandler(this IApplicationBuilder application)
        {
            var MyAppConfig = EngineContext.Current.Resolve<MyAppConfig>();
            var hostingEnvironment = EngineContext.Current.Resolve<IHostingEnvironment>();
            var useDetailedExceptionPage = MyAppConfig.DisplayFullErrorStack || hostingEnvironment.IsDevelopment();
        ...
        /// </summary>
        /// <param name="application">Builder for configuring an application's request pipeline</param>
        public static void UseMyAppAuthentication(this IApplicationBuilder application)
        {
            //check whether database is installed
            if (!DataSettingsManager.DatabaseIsInstalled)
                return;
        ...
        /// </summary>
        /// <param name="application">Builder for configuring an application's request pipeline</param>
        public static void UseMyAppMvc(this IApplicationBuilder application)
        {
