...
using MyApp.Infrastructure.Common.Authentication;
...
namespace SPA.Infrastructure.Extensions
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        /// </summary>
        /// <param name="services">Collection of service descriptors</param>
        public static void AddMyAppAuthentication(this IServiceCollection services)
        {
            //set default authentication schemes
            var authenticationBuilder = services.AddAuthentication(options =>
            {
                options.DefaultScheme = MyAppCookieAuthenticationDefaults.AuthenticationScheme;
                options.DefaultSignInScheme = MyAppCookieAuthenticationDefaults.ExternalAuthenticationScheme;
            });
        }
