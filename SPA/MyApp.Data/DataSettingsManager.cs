...
namespace MyApp.Infrastructure.Data
{
    ...
    public partial class DataSettingsManager
    {
        ...
        public static DataSettings LoadSettings(string filePath = null, bool reloadSettings = false, IMyAppFileProvider fileProvider = null)
        {
        ...
        /// <param name="fileProvider">File provider</param>
        public static void SaveSettings(DataSettings settings, IMyAppFileProvider fileProvider = null)
        {
        ...
        /// <summary>
        /// Gets a path to the file that was used in old MyAppCommerce versions to contain data settings
        /// </summary>
