...
namespace MyApp.Infrastructure.Data
{
    ...
    public partial class MyAppObjectContext : DbContext, IDbContext
    {
        ...
        public MyAppObjectContext(DbContextOptions<MyAppObjectContext> options) : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var typeConfigurations = Assembly.GetExecutingAssembly().GetTypes().Where(type => 
                (type.BaseType?.IsGenericType ?? false) 
                    && (type.BaseType.GetGenericTypeDefinition() == typeof(MyAppEntityTypeConfiguration<>) 
                        || type.BaseType.GetGenericTypeDefinition() == typeof(MyAppQueryTypeConfiguration<>)));
