...
namespace MyApp.Core.Abstractions.Infrastructure
{
    ...
    public interface IEngine
    {
        ...
        void Initialize(IServiceCollection services, IMyAppFileProvider MyAppFileProvider, MyAppConfig MyAppConfig);
        ...
        IServiceProvider ConfigureServices(IServiceCollection services, MyAppConfig configuration);
